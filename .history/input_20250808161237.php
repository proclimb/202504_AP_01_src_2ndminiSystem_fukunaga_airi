...
<head>
    ...
    <style>
        /* ─────────────────────────────────────────
   すべての .form-block を 2 列×2 行の Grid に
────────────────────────────────────────── */
        .form-block {
        ...
        /* ── ④ 中の .error-msg2 はブロック表示＆折り返し ── */
        .postal-error-placeholder,
        .form-block>.error-msg,
        .form-block>.error-msg2 {
            display: block;
            width: 100%;
        ...
        .postal-row+.postal-error-placeholder .error-msg2 {
        ...
        .postal-error-placeholder .error-msg2 {
            display: block !important;
            white-space: normal !important;
            /* 折り返し許可 */
            word-break: break-word !important;
        ...
        <form id="edit-form" action="input.php" method="post" name="edit" onsubmit="return validateAllFields()">
            ...
            <div>
                ...
                <?php if (isset($error_message['password2'])) : ?>
                    <div class="error-msg"><?= htmlspecialchars($error_message['password2']) ?></div>
                <?php endif ?>
