            ...
            <div>
                ...
                <div class="form-block">
                    ...
                    <?php if (isset($error_message['address'])) : ?>
                        <div class="error-msg2"><?= htmlspecialchars($error_message['address']) ?></div>
                    <?php endif ?>
                </div>
                ...
                <div class="form-block">
                    ...
                    <?php if (isset($error_message['tel'])) : ?>
                        <div class="error-msg2"><?= htmlspecialchars($error_message['tel']) ?></div>
                    <?php endif ?>
                </div>
                ...
                <div class="form-block">
                    ...
                    <?php if (isset($error_message['email'])) : ?>
                        <div class="error-msg" 2><?= htmlspecialchars($error_message['email']) ?></div>
                    <?php endif  ?>
                </div>
                <!-- パスワード -->
                <div class="form-block">
